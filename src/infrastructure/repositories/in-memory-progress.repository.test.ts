...
describe("InMemoryProgressRepository", () => {
  ...
  describe("delete", () => {
    ...
    it("should delete existing progress", async () => {
      ...
      const found = await repository.findByUserAndConcept(
        "user-1",
        "concept-1",
      );
  ...
  describe("Integration with other user progress", () => {
    it("should not affect other users progress", async () => {
      const user1Progress = await repository.create({
        userId: "user-1",
        conceptId: "concept-1",
        status: "learning",
        nextReview: new Date("2024-01-10"),
      ...
      const user2Progress = await repository.create({
        userId: "user-2",
        conceptId: "concept-1",
        status: "stable",
        nextReview: new Date("2024-01-15"),
      ...
      expect(unchangedProgress).toEqual(user2Progress);
    ...
    it("should not affect other concepts progress for same user", async () => {
      const concept1Progress = await repository.create({
        userId: "user-1",
        conceptId: "concept-1",
        status: "learning",
        nextReview: new Date("2024-01-10"),
      ...
      const concept2Progress = await repository.create({
        userId: "user-1",
        conceptId: "concept-2",
        status: "stable",
        nextReview: new Date("2024-01-15"),
