...
import { getNextQuestion, type GetNextQuestionInput, type GetNextQuestionOutput } from './getNextQuestion.usecase'
...
describe('getNextQuestion Use Case', () => {
  ...
  it('should call repository with correct userId', async () => {
    ...
    expect(mockQuestionRepo.findDueQuestions).toHaveBeenCalledWith('specific-user-id')
  })
